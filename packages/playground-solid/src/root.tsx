...
function Logo({ className }) {
  return (
    <svg class={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 243 42">
      <path
        fill="#fff"
        ...
        <Suspense>
          <ErrorBoundary>
            <div class="flex-1 overflow-auto bg-gray-50">
              <header class="relative z-10 flex flex-shrink-0 items-center justify-between border-b border-gray-200 bg-gray-700 px-4 py-4 sm:px-6 lg:px-8">
                <A href="/">
                  <Logo className="h-6" />
                </A>
              </header>
